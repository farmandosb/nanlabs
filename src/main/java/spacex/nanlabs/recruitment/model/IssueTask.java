...
public class IssueTask extends ManagedTask implements ITrelloCard{
	String title="";
	String description="";
	String idList="";
	...
	public String toString() {
		return "IssueTask [title=" + title + ", description=" + description + ", idList=" + idList + ", idMembers="
				+ Arrays.toString(idMembers) + ", idLabels=" + Arrays.toString(idLabels) + ", type=" + type + "]";
	}
